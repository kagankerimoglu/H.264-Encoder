...
def resource_path(relative_path):
    try:
        ...
        base_path = os.path.abspath("./ffmpeg/7.0/bin")

    return os.path.join(base_path, relative_path)

encoder = resource_path('./ffmpeg/7.0/bin/ffmpeg')
...
def encode():
    ...
    if file_path:
        ...
        encoder_path = os.path.join(os.path.dirname(__file__), 'ffmpeg/7.0/bin/ffmpeg')
